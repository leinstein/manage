          ...
          <div class="layui-form-item">
            ...
            <div id="orderfee">
                <table class="layui-table" style="width: 96%">
                    <tr>
                        <th>订单原价:</th>
                        <td><font>￥</font> <span style="color: red" id="totlepay"><?php echo ($order["totalpeice"]); ?></span></td>
                        <th>优惠金额:</th>
                        <td><font>￥</font> <span style="color: red" id="ppay"><?php echo (substr($order["cheapprice"],0,-3)); ?></span></td>
                        <th>已付款:</th>
                        <td><font>￥</font> <span style="color: red" id="payyi"><?php echo (substr($order["pay"],0,-3)); ?></span></td>
                        <th>快递代收款:</th>
                        <td><font>￥</font> <span style="color: red" id="paydai"><?php echo (substr($order["paymentfee"],0,-3)); ?></span></td>
                    </tr>
                </table>
            </div>
