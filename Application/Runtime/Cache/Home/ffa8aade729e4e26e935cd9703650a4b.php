        ...
        <tbody>
          ...
          <?php if($v['orderstatus'] == 4): ?><tr style="color:#999"><?php endif; ?>
              ...
              <td class="td-manage">
                ...
                <a title="编辑" href="javascript:;" onclick="x_admin_show('编辑','/Home/Order/edit?orderid=<?php echo ($v["orderid"]); ?>',1280,760)" class="ml-5" style="margin-right: 10px">
                  <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="仓管" href="javascript:;" onclick="x_admin_show('仓管','/Home/Order/update_order?orderid=<?php echo ($v["orderid"]); ?>',800,500)" class="ml-5" style="margin-right: 10px">
          ...
          <?php if($v['orderstatus'] == 4): ?><tr style="color:#999"><?php endif; ?>
              ...
              <td><?php echo ($v["nickname"]); ?></td>
              <td class="td-manage">
                <a title="订单详情"  onclick="x_admin_show('查看','/Home/Order/show?orderid=<?php echo ($v["orderid"]); ?>',1200,700)" href="javascript:;" style="margin-right: 10px">
                  <i class="layui-icon">&#xe63c;</i>
                </a>
               <a title="编辑" href="javascript:;" onclick="x_admin_show('编辑','/Home/Order/edit?orderid=<?php echo ($v["orderid"]); ?>',1280,760)" class="ml-5" style="margin-right: 10px">
                  <i class="layui-icon">&#xe642;</i>
