...
<html>
    ...
    <body>
        <div class="x-body">
            ...
            <style>.layui-col-md2{width: 14.2857143%;min-width: 130px;height: 180px}</style>
                ...
                <div style="height: 180px;background-color: white;">
                    <div class="layui-row" style="width: 100%;margin-left: 0;">
                        <div class="layui-col-md2">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["one"]); ?></div>
                        ...
                        <div class="layui-col-md2">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["two"]); ?></div>
                            <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                        <div class="layui-col-md2">
                          <div class="rate_title">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["three"]); ?></div>
                            <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                        <div class="layui-col-md2">
                          <div class="rate_title">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["four"]); ?></div>
                            <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                       <div class="layui-col-md2">
                          <div class="rate_title">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["five"]); ?></div>
                           <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                        <div class="layui-col-md2">
                          <div class="rate_title">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["six"]); ?></div>
                            <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                        <div class="layui-col-md2">
                          <div class="rate_title">
                          ...
                          <div class="order_total"  style="margin-top: -15px">复购单数：<?php echo ($buyrate["seven"]); ?></div>
                            <div class="order_total">总订单数：<?php echo ($buyrate["basic"]); ?></div>
                        </div>
                    </div>
                </div>
