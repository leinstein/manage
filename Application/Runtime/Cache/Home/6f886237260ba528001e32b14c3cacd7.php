                    ...
                    <div class="layui-input-inline">
                      <select name="auth_pid">
                        <option value="0">请选择上级</option>
                            <?php if(is_array($authinfo)): foreach($authinfo as $key=>$v): ?><option value="<?php echo ($v["auth_id"]); ?>"><?php echo str_repeat('&nbsp;',$v['level']*10);?>┝ <?php echo ($v["auth_name"]); ?></option><?php endforeach; endif; ?>
                      </select>
                    </div>
                    <div class="layui-form-mid layui-word-aux">
