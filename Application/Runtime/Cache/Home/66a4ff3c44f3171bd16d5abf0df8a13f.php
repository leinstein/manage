        ...
        <form class="layui-form" onsubmit="return false">
          ...
          <div class="layui-form-item" style="width: 47%;display: inline-block;">
              ...
              <div class="layui-input-inline" style="width: 230px">
                  <select name="type">
                    <option value="客户跟踪" selected><?php echo ($backlog_b["type"]); ?></option>
                  </select>
              </div>
          </div>
          ...
          <div class="layui-form-item" style="width: 47%;display: inline-block;">
              ...
              <div class="layui-input-inline">
                      <input class="layui-input" name="do_time" placeholder="执行时间" value="<?php echo (date('Y-m-d',$backlog_b["do_time"])); ?>" id="LAY_demorange_s" style="width: 230px" autocomplete="off">
              </div>
          </div>
          ...
          <div class="layui-form-item layui-form-text" style="width: 93%">
              ...
              <div class="layui-input-block">
                  ...
                  <textarea style="width: 103%;border: 0;min-height: 20px" readonly placeholder="请输入任务反馈" id="" name="content" class="layui-textarea"><?php echo ($backlog_b["content"]); ?></textarea>
              </div>
          </div>
          ...
          <div class="layui-form-item layui-form-text" style="width: 93%">
              ...
              <div class="layui-input-block">
                  <textarea style="width: 103%" placeholder="请输入内容" id="recontent" name="recontent" class="layui-textarea"><?php echo ($backlog_b["recontent"]); ?></textarea>
              </div>
          </div>
          <div class="layui-form-item">
