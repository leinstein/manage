...
<html>
    ...
    <body>
        <div class="x-body">
            ...
            <xblock>
                <?php if(in_array(($action_name["Customer_add"]), is_array($role_ac)?$role_ac:explode(',',$role_ac))): ?><button class="layui-btn" style="width: 125px;font-size: 16px;" onclick="member_add('添加客户','/Home/Customer/add','1000','760')"><i class="layui-icon">&#xe608;</i> 添 加</button>
                <?php else: ?>
                    <button class="layui-btn layui-btn-disabled-button" style="width: 125px;font-size: 16px;"><i class="layui-icon">&#xe608;</i> 添 加</button><?php endif; ?>
            ...
            <table class="layui-table">
                ...
                <tbody>
                    ...
                    <?php if(is_array($infotoday)): foreach($infotoday as $key=>$v): ?><tr>
                            ...
                            <td class="td-manage">
                                <?php if(in_array(($action_name["Customer_order_add"]), is_array($role_ac)?$role_ac:explode(',',$role_ac))): ?><a title="添加订单" href="javascript:;" onclick="order_add_list('添加订单','/Home/Customer/order_add','<?php echo ($v["cid"]); ?>','1280','760','<?php echo ($v["nickname"]); ?>')" class="ml-5" style="text-decoration:none">
                                        <img src="/Public/Home/images/jia.png" width="15px">
                                    </a>
                                <?php else: ?>
                                    <a title="添加订单" href="javascript:;" class="ml-5 layui-btn-disabled-button" style="text-decoration:none">
                                        <img src="/Public/Home/images/jia.png" width="15px">
                                    </a><?php endif; ?>
                                <?php if(in_array(($action_name["Customer_edit"]), is_array($role_ac)?$role_ac:explode(',',$role_ac))): ?><a title="编辑客户" href="javascript:;" onclick="member_edit('编辑客户','/Home/Customer/edit','<?php echo ($v["cid"]); ?>','1000','760')" class="ml-5" style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
                                <?php else: ?>
                                    <a title="编辑客户" href="javascript:;"  class="ml-5 layui-btn-disabled-button" style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a><?php endif; ?>
                                <?php if(in_array(($action_name["Customer_addbacklog"]), is_array($role_ac)?$role_ac:explode(',',$role_ac))): ?><a title="添加待办任务" href="javascript:;" onclick="member_edit('添加待办任务','/Home/Customer/addbacklog','<?php echo ($v["cid"]); ?>','1000','700')" class="ml-5" style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe609;</i>
                                    </a>
                                <?php else: ?>
                                    <a title="添加待办任务" href="javascript:;" class="ml-5 layui-btn-disabled-button" style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe609;</i>
                                    </a><?php endif; ?>
                                <?php if(in_array(($action_name["Customer_del"]), is_array($role_ac)?$role_ac:explode(',',$role_ac))): ?><a title="删除客户" href="javascript:;" onclick="member_del(this,'<?php echo ($v["cid"]); ?>')"
                                       style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                <?php else: ?>
                                    <a title="删除客户" href="javascript:;" class="layui-btn-disabled-button" style="text-decoration:none;margin-left: 10px">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a><?php endif; ?>
                            </td>
