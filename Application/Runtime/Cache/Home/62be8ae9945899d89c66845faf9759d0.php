    ...
    <div class="x-body">
        <form class="layui-form" onsubmit="return false">
          <input type="hidden" name="cid" value="<?php echo ($data["cid"]); ?>">
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="<?php echo ($data["cname"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电话&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($customer["phone"]); ?>" required="" disabled="disabled"
                        ...
                        <tr>
                            <td id="show_goods" onclick="show_goods()">
                                <i class="layui-icon">&#xe608;</i> 添 加 商 品
                                    <!--<i class="layui-icon" id="show_goods" onclick="show_goods()" style="font-size: 31px;color: #009688;">+</i>-->
                            </td>
                        </tr>
                      </tbody>
                  </table>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                      <input class="layui-input" name="deliverytime" placeholder="发货时间" id="LAY_demorange_s">
              </div>
          </div>
            ...
            <div id="orderfee">
                <table class="layui-table" style="width: 96%">
                    <tr>
                        <th>订单原价:</th>
                        <td><font>￥</font> <span  id="totlepay">0</span></td>
                        <th>优惠金额:</th>
                        <td><font>￥</font> <span  id="ppay">0</span></td>
                        <th>已付款:</th>
                        <td><font>￥</font> <span id="payyi">0</span></td>
                        <th>快递代收款:</th>
                        <td><font>￥</font> <span id="paydai">0</span></td>
                        <!--<th>订单金额</th>-->
                        <!--<td><font>￥</font> <span  id="nowpay">0</span></td>-->
                    </tr>
                </table>
            </div>
