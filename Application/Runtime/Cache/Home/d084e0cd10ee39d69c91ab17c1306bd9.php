        ...
        <div class="x-body">
            <form class="layui-form" onsubmit="return false">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_age" name="age"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_c_weixin" name="c_weixin"
                               autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_a_role" name="a_role"
                               autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                        用于跟此客户交流微信名称
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_a_weixin" name="a_weixin"
                               autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                        用于跟此客户交流微信号
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 82%;margin-left: 110px;margin-top: 15px;">
                        <input type="text" id="L_address" name="address" required="" placeholder="请输入详细地址"
