...
<html>
    ...
    <body style="overflow-x:hidden;background-color: #f0f2f5;">
        <div class="x-body">
            <!--头部统计-->
            <div class="layui-row content_title_box layui-col-space20">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md3 col_content">
                    <div class="bg_color">
                        <div class="l_box">
            ...
            <div class="layui-row sec_black">
                ...
                <div class="layui-col-xs3 layui-col-sm3 layui-col-md3  col_content" style="min-width: 380px;margin-top: 0">
                  <div class="sec_bg_color">
                        <div class="layui-tab layui-tab-brief" style="">
                          ...
                          <div class="layui-tab-content">
                                ...
                                <ul class="list">
                                    <li style="margin-top: 8px">
                                        <span class="list_icon list_bg" style="color: white;">
                                            <img src="<?php echo ($order_rank["month"]["0"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["month"]["1"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["month"]["2"]["img_small"]); ?>"  style="">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["month"]["3"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["month"]["4"]["img_small"]); ?>">
                                        </span>
                            ...
                            <div class="layui-tab-item">
                                <ul class="list">
                                    <li style="margin-top: 8px">
                                        <span class="list_icon list_bg" style="color: white;">
                                            <img src="<?php echo ($order_rank["lastmonth"]["0"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["lastmonth"]["1"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["lastmonth"]["2"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["lastmonth"]["3"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["lastmonth"]["4"]["img_small"]); ?>">
                                        </span>
                            ...
                            <div class="layui-tab-item">
                                <ul class="list">
                                    <li style="margin-top: 8px">
                                        <span class="list_icon list_bg" style="color: white;">
                                            <img src="<?php echo ($order_rank["history"]["0"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["history"]["1"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg" style="color: white">
                                            <img src="<?php echo ($order_rank["history"]["2"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["history"]["3"]["img_small"]); ?>">
                                        </span>
                                    ...
                                    <li>
                                        <span class="list_icon list_bg">
                                            <img src="<?php echo ($order_rank["history"]["4"]["img_small"]); ?>">
                                        </span>
